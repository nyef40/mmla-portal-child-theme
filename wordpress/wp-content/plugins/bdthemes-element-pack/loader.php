...
class Element_Pack_Loader {
	...
	public function register_site_scripts() {
		...
		if ( element_pack_is_widget_enabled( 'interactive-card' ) or element_pack_is_widget_enabled( 'image-expand' ) or element_pack_is_widget_enabled( 'animated-heading' ) or element_pack_is_widget_enabled( 'stacker' ) or element_pack_is_widget_enabled( 'horizontal-scroller' ) or element_pack_is_widget_enabled( 'marquee' ) or element_pack_is_widget_enabled( 'svg-image' ) ) {
		...
		if ( element_pack_is_third_party_enabled( 'acf-accordion' ) ) {
			wp_register_script( 'ep-accordion', BDTEP_ASSETS_URL . 'js/modules/ep-accordion' . $suffix . '.js', ['jquery', 'bdt-uikit', 'elementor-frontend'], BDTEP_VER, true );
		}
		if ( element_pack_is_third_party_enabled( 'acf-gallery' ) ) {
			wp_register_script( 'ep-advanced-image-gallery', BDTEP_ASSETS_URL . 'js/modules/ep-advanced-image-gallery' . $suffix . '.js', ['jquery', 'bdt-uikit', 'elementor-frontend'], BDTEP_VER, true );
		}
		if ( element_pack_is_third_party_enabled( 'acf-slider' ) ) {
			wp_register_script( 'ep-slider', BDTEP_ASSETS_URL . 'js/modules/ep-slider' . $suffix . '.js', ['jquery', 'bdt-uikit', 'elementor-frontend'], BDTEP_VER, true );
		}
		if ( element_pack_is_third_party_enabled( 'acf-tabs' ) ) {
			wp_register_script( 'ep-tabs', BDTEP_ASSETS_URL . 'js/modules/ep-tabs' . $suffix . '.js', ['jquery', 'bdt-uikit', 'elementor-frontend'], BDTEP_VER, true );
		}
	}
