			...
			<div class="bdt-ep-advanced-calculator-wrapper">
				<form class="bdt-ep-advanced-calculator-form bdt-flex bdt-flex-wrap">
					...
					foreach ( $settings['form_fields'] as $item_index => $item ) :
						...
						?>
						<div
							class="bdt-ep-advanced-calculator-field-wrap bdt-field-group bdt-width-1-1 bdt-first-column elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>">
							...
							switch ( $item['field_type'] ) {
								...
								case 'number':
									if ( $settings['show_labels'] ) {
										echo '<label ' . wp_kses_post( $this->get_render_attribute_string( 'field_label' . $item_index ) ) . '>' . esc_html( $item['field_label'] ) . '</label>';
									}
					...
					<div
						class="bdt-ep-advanced-calculator-field-wrap bdt-field-group bdt-width-1-1 bdt-first-column  bdt-ep-advanced-calculator-error bdt-hidden">
