...
class Animated_Card extends Module_Base {
	...
	public function render_animated_content() {
		...
		if ( $settings['title_link_url']['url'] ) {
			...
			$this->add_render_attribute( 'animated-title', 'onclick', "window.open('" . esc_url($settings['title_link_url']['url']) . "', '$target')" );
		}
		...
		<?php if ( 'yes' == $settings['show_sub_title'] ) : ?>
			<?php if ( $settings['sub_title_text'] ) : ?>
				<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['sub_title_size'] ) ); ?>
					<?php $this->print_render_attribute_string( 'animated_sub_title' ); ?>>
		...
		<?php if ( 'yes' == $settings['show_title'] ) : ?>
			<?php if ( $settings['title_text'] ) : ?>
				<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_size'] ) ); ?>
					<?php $this->print_render_attribute_string( 'animated-title' ); ?>>
	...
	public function render() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'animated-card' ); ?>>
