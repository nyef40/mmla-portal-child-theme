		...
		if (bbp_is_forum_edit()) : ?>
					...
					<form id="new-post" name="new-post" method="post">
						...
						<fieldset class="bbp-form">
							<legend>
								...
								<?php
								if (bbp_is_forum_edit()) :
									printf(esc_html__('Now Editing &ldquo;%s&rdquo;', 'bbpress'), esc_html(bbp_get_forum_title()));
								else :
									bbp_is_single_forum()
										? printf(esc_html__('Create New Forum in &ldquo;%s&rdquo;', 'bbpress'), esc_html(bbp_get_forum_title()))
							...
							<div>
								...
								<p>
									<label for="bbp_forum_title"><?php printf(esc_html__('Forum Name (Maximum Length: %d):', 'bbpress'), esc_html(bbp_get_title_max_length())); ?></label><br />
			...
			<?php elseif (bbp_is_forum_closed()) : ?>
				...
				<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The forum &#8216;%s&#8217; is closed to new content.', 'bbpress'), esc_html(bbp_get_forum_title())); ?></li>
						</ul>
					</div>
				</div>
