		...
		<?php if (bbp_is_reply_edit()) : ?>
				...
				<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
					<form id="new-post" name="new-post" method="post">
						...
						<fieldset class="bbp-form">
							<legend><?php printf(esc_html__('Reply To: %s', 'bdthemes-element-pack'), (bbp_get_form_reply_to()) ? sprintf(esc_html__('Reply #%1$s in %2$s', 'bdthemes-element-pack'), bbp_get_form_reply_to(), bbp_get_topic_title()) : bbp_get_topic_title()); ?></legend>
							<?php do_action('bbp_theme_before_reply_form_notices'); ?>
							<?php if (!bbp_is_topic_open() && !bbp_is_reply_edit()) : ?>
								<div class="bbp-template-notice">
									<ul>
										<li><?php esc_html_e('This topic is marked as closed to new replies, however your posting capabilities still allow you to reply.', 'bdthemes-element-pack'); ?></li>
									</ul>
								</div>
							<?php endif; ?>
							<?php if (!bbp_is_reply_edit() && bbp_is_forum_closed()) : ?>
								<div class="bbp-template-notice">
									<ul>
										<li><?php esc_html_e('This forum is closed to new content, however your posting capabilities still allow you to post.', 'bdthemes-element-pack'); ?></li>
									</ul>
								</div>
							<?php endif; ?>
							<?php if (current_user_can('unfiltered_html')) : ?>
								<div class="bbp-template-notice">
									<ul>
										<li><?php esc_html_e('Your account has the ability to post unrestricted HTML content.', 'bdthemes-element-pack'); ?></li>
									</ul>
								</div>
							<?php endif; ?>
							...
							<div>
								<?php if (bbp_current_user_can_access_anonymous_user_form()) : ?>
									...
									<fieldset class="bbp-form">
										<legend><?php (bbp_is_topic_edit() || bbp_is_reply_edit()) ? esc_html_e('Author Information', 'bdthemes-element-pack') : esc_html_e('Your information:', 'bdthemes-element-pack'); ?></legend>

										<?php do_action('bbp_theme_anonymous_form_extras_top'); ?>

										<p>
											<label class="bdt-inline-block" for="bbp_anonymous_author"><?php esc_html_e('Name (required):', 'bdthemes-element-pack'); ?></label><br />
										...
										<p>
											<label class="bdt-inline-block" for="bbp_anonymous_email"><?php esc_html_e('Mail (will not be published) (required):', 'bdthemes-element-pack'); ?></label><br />
											<input type="text" id="bbp_anonymous_email" value="<?php bbp_author_email(); ?>" size="40" maxlength="100" name="bbp_anonymous_email" />
										</p>

										<p>
											<label class="bdt-inline-block" for="bbp_anonymous_website"><?php esc_html_e('Website:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (!(bbp_use_wp_editor() || current_user_can('unfiltered_html'))) : ?>
									<p class="form-allowed-tags">
										<label class="bdt-inline-block"><?php esc_html_e('You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (bbp_allow_topic_tags() && current_user_can('assign_topic_tags', bbp_get_topic_id())) : ?>
									...
									<p>
										<label class="bdt-inline-block" for="bbp_topic_tags"><?php esc_html_e('Tags:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (bbp_is_subscriptions_active() && !bbp_is_anonymous() && (!bbp_is_reply_edit() || (bbp_is_reply_edit() && !bbp_is_reply_anonymous()))) : ?>
									...
									<p>
										...
										<?php if (bbp_is_reply_edit() && (bbp_get_reply_author_id() !== bbp_get_current_user_id())) : ?>
											<label class="bdt-inline-block" for="bbp_topic_subscription"><?php esc_html_e('Notify the author of follow-up replies via email', 'bdthemes-element-pack'); ?></label>
										<?php else : ?>
											<label class="bdt-inline-block" for="bbp_topic_subscription"><?php esc_html_e('Notify me of follow-up replies via email', 'bdthemes-element-pack'); ?></label>
										<?php endif; ?>
									</p>
								...
								<?php if (bbp_is_reply_edit()) : ?>
									<?php if (current_user_can('moderate', bbp_get_reply_id())) : ?>
										...
										<p class="form-reply-to">
											<label class="bdt-inline-block" for="bbp_reply_to"><?php esc_html_e('Reply To:', 'bdthemes-element-pack'); ?></label><br />
										...
										<p>
											<label class="bdt-inline-block" for="bbp_reply_status"><?php esc_html_e('Reply Status:', 'bdthemes-element-pack'); ?></label><br />
									...
									<?php if (bbp_allow_revisions()) : ?>
										...
										<fieldset class="bbp-form">
											<legend>
												...
												<label class="bdt-inline-block" for="bbp_log_reply_edit"><?php esc_html_e('Keep a log of this edit:', 'bdthemes-element-pack'); ?></label><br />
											</legend>

											<div>
												<label class="bdt-inline-block" for="bbp_reply_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), bbp_get_current_user_name()); ?></label><br />
								...
								<div class="bbp-submit-wrapper">
									...
									<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit"><?php esc_html_e('Submit', 'bdthemes-element-pack'); ?></button>
			...
			<?php elseif (bbp_is_topic_closed()) : ?>
				...
				<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The topic &#8216;%s&#8217; is closed to new replies.', 'bdthemes-element-pack'), bbp_get_topic_title()); ?></li>
						</ul>
					</div>
				</div>
			...
			<?php elseif (bbp_is_forum_closed(bbp_get_topic_forum_id())) : ?>
				...
				<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bdthemes-element-pack'), bbp_get_forum_title(bbp_get_topic_forum_id())); ?></li>
						</ul>
					</div>
				</div>
				...
				<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
					<div class="bbp-template-notice">
						<ul>
							<li><?php is_user_logged_in()
									? esc_html_e('You cannot reply to this topic.',               'bdthemes-element-pack')
									: esc_html_e('You must be logged in to reply to this topic.', 'bdthemes-element-pack');
								?></li>
						</ul>
					</div>
					...
					<?php if (!is_user_logged_in()) : ?>
						<form method="post" action="<?php bbp_wp_login_action(array('context' => 'login_post')); ?>" class="bbp-login-form">
							<fieldset class="bbp-form">
								<legend><?php esc_html_e('Log In', 'bdthemes-element-pack'); ?></legend>
								<div class="bbp-username">
									<label class="bdt-inline-block" for="user_login"><?php esc_html_e('Username', 'bdthemes-element-pack'); ?>: </label>
								...
								<div class="bbp-password">
									<label class="bdt-inline-block" for="user_pass"><?php esc_html_e('Password', 'bdthemes-element-pack'); ?>: </label>
								...
								<div class="bbp-remember-me">
									...
									<label class="bdt-inline-block" for="rememberme"><?php esc_html_e('Keep me signed in', 'bdthemes-element-pack'); ?></label>
								</div>
								<?php do_action('login_form'); ?>
								<div class="bbp-submit-wrapper">
									<button type="submit" name="user-submit" id="user-submit" class="button submit user-submit"><?php esc_html_e('Log In', 'bdthemes-element-pack'); ?></button>
