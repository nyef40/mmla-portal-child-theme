...
?>
        <div class="bdt-ep-carousel-thumbnail">
            ...
            if ('yes' == $settings['show_link_option']) { ?>
                ...
                title="<?php echo ('yes' == $settings['show_caption']) ? esc_html($thumbnail_caption) : '' ?>">
                <?php
            } ?>
    ...
    ?>
        ...
        <<?php
            echo esc_attr(Utils::get_valid_html_tag($tag)); ?> class="<?php echo esc_attr(implode(" ", $classes)); ?>">
            <a href="<?php echo esc_url(get_permalink()); ?>">
                <?php
                the_title();
                ?>
            ...
            echo esc_attr(Utils::get_valid_html_tag($tag)); ?>>
    <?php
    }
    ...
    ?>
        <div class="bdt-ep-carousel-excerpt">
            ...
            if (has_excerpt()) {
                ...
                echo wp_kses_post(element_pack_custom_excerpt($this->get_settings_for_display('excerpt_length'), $strip_shortcode, $ellipse));
            }
            ?>
        </div>
    <?php
    ...
    ?>
        <a class="bdt-ep-carousel-button elementor-button elementor-size-<?php
            ...
            <span <?php
                    $this->print_render_attribute_string('carousel-button'); ?>>
                <?php
