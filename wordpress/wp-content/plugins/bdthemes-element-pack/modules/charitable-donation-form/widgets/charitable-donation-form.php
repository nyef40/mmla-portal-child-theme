...
class Charitable_Donation_Form extends Module_Base {
    ...
    protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Donation Form', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Details Text Color', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Update Text Color', 'bdthemes-element-pack' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Prement Text Color', 'bdthemes-element-pack' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Donation Fields', 'bdthemes-element-pack' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Field', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Placeholder Text Color', 'bdthemes-element-pack' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Normal Color', 'bdthemes-element-pack' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		<div <?php $this->print_render_attribute_string('charitable_wrapper'); ?>>
