...
?>
        ...
        <div <?php $this->print_render_attribute_string('circle_info'); ?>>
            <div class="bdt-ep-circle-info-wrap" id="bdt-ep-circle-info-<?php echo esc_attr($this->get_id()); ?>">
                    ...
                    ?>
                        ...
                        <div <?php $this->print_render_attribute_string('circle_content'); ?>>
                            ...
                            <div class="bdt-ep-circle-info-content-inner">
                                <div>
                                    <a <?php $this->print_render_attribute_string($link_key); ?>>
                                        <<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('circle_title_tags'); ?>>
