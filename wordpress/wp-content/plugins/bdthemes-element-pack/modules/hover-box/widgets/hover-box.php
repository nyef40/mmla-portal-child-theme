...
class Hover_Box extends Module_Base {
	...
	public function box_items() {
		...
		<div <?php $this->print_render_attribute_string( 'box-settings' ); ?>>
			<div class="bdt-grid bdt-grid-<?php echo esc_attr( $settings['column_gap'] ); ?> bdt-child-width-1-<?php echo esc_attr( $mobile_cols ); ?> bdt-child-width-1-<?php echo esc_attr( $tablet_cols ); ?>@s bdt-child-width-1-<?php echo esc_attr( $desktop_cols ); ?>@l"
				data-bdt-grid>
				...
				<?php foreach ( $settings['hover_box'] as $index => $item ) :
					...
					?>
					<div>
						<div <?php $this->print_render_attribute_string( 'box-item' ); ?> data-id="<?php echo esc_attr( $tab_id ); ?>">
							...
							<?php if ( $item['hover_box_title'] && ( 'yes' == $settings['show_title'] ) ) : ?>
								<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_tags'] ) ); ?>
									<?php $this->print_render_attribute_string( 'bdt-ep-hover-box-title' ); ?>>
