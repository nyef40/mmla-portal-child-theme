...
?>
        ...
        <div <?php $this->print_render_attribute_string('hover_video_attr'); ?>>
            ...
            <div <?php $this->print_render_attribute_string('hover_video_wrapper'); ?>>
                ...
                ?>
                    <video <?php $this->print_render_attribute_string('bdt_hover_video_attr'); ?> oncontextmenu="return false;" src="<?php echo esc_url($video_source); ?>" poster="<?php echo esc_url($video_poster); ?>" muted>
                    </video>
                <?php endforeach; ?>
