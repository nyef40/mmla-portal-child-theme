...
class Portfolio_Gallery extends Module_Base {
	...
	public function render_filter_menu() {
		...
		?>
		<div class="bdt-ep-grid-filters-wrapper" id="<?php echo 'bdt-portfolio-gallery-' . $this->get_id(); ?>" <?php $this->print_render_attribute_string( 'portfolio-gallery-hash-data' ); ?>>
