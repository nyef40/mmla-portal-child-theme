...
?>
	...
	?>
		<div <?php $this->print_render_attribute_string('post-card'); ?>>
					...
					<div class="bdt-post-card-item">
						...
						<div class="bdt-post-card-desc">
							...
							<?php if ('yes' == $settings['title']) : ?>
								<<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('bdt-post-card-title'); ?>>
