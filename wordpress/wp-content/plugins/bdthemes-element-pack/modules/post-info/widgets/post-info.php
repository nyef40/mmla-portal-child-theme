...
?>
	...
	protected function render_item_text($item_data, $repeater_index) {
		...
		$this->add_render_attribute($repeater_setting_key, 'class', ['elementor-icon-list-text', 'upk-post-info__item', 'upk-post-info__item--type-' . $item_data['type']]);
		...
		<span <?php $this->print_render_attribute_string($repeater_setting_key); ?>>
			<?php if (!empty($item_data['text_prefix'])) : ?>
				<span class="upk-post-info__item-prefix"><?php echo esc_html($item_data['text_prefix']); ?></span>
			<?php endif; ?>
			<?php
			if (!empty($item_data['terms_list'])) :
				$terms_list = [];
				$item_class = 'upk-post-info__terms-list-item';
			?>
				<span class="upk-post-info__terms-list">
					<?php
	...
	protected function render() {
		...
		$this->add_render_attribute('icon_list', 'class', ['upk-post-info', 'elementor-icon-list-items',]);
	?>
