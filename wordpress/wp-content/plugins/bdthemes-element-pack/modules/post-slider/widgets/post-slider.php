...
?>
		<div <?php $this->print_render_attribute_string('slider-text'); ?> data-bdt-slideshow-parallax="x: 500,-500">
			<?php
			if (has_excerpt()) {
				the_excerpt();
			} else {
	...
	?>
		<div class="bdt-post-slider-title-wrap">
			<a href="<?php echo esc_url(get_permalink()); ?>">
				<<?php echo esc_attr(Utils::get_valid_html_tag($tag)); ?> class="bdt-post-slider-title bdt-margin-remove-bottom" data-bdt-slideshow-parallax="x: 200,-200">
					<?php the_title() ?>
	...
	?>
		<div <?php $this->print_render_attribute_string('post-slider-item'); ?>>
				...
				<div class="bdt-post-slider-content">
					...
					if ($settings['show_meta']) : ?>
						<div class="bdt-post-slider-meta bdt-flex-inline bdt-flex-middle" data-bdt-slideshow-parallax="x: 250,-250">
							<a class="bdt-flex bdt-flex-middle" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">
							...
							<a href="#">
								<div class="bdt-flex bdt-flex-middle bdt-text-left">
									...
									<div class="bdt-margin-small-left bdt-visible@m">
										<<?php echo esc_attr(Utils::get_valid_html_tag($settings['thumb_title_tag'])); ?> class="bdt-margin-remove-bottom thumb-title-default-skin">
											<?php echo esc_attr(get_the_title()); ?>
										</<?php echo esc_attr(Utils::get_valid_html_tag($settings['thumb_title_tag'])); ?>>
