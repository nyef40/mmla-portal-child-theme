...
class Table extends Module_Base {
						...
						<th <?php $this->print_render_attribute_string( $column_repeater_key ); ?>>
							<div class="bdt-static-column-cell-wrap">
								...
								<div class="bdt-static-column-cell-text">
									<?php echo esc_html( $column_cell['static_column_name'] ); ?>
								</div>
								...
								<?php if ( isset ( $column_cell['static_column_image']['url'] ) || isset ( $column_cell['static_column_image']['id'] ) ) :
									...
									?>
									<div class="bdt-static-column-cell-icon">
										<?php echo wp_kses_post( Group_Control_Image_Size::get_attachment_image_html( $column_cell, 'static_column_thumbnail', 'static_column_image' ) ); ?>
									</div>
								<?php endif; ?>
								...
								<td <?php $this->print_render_attribute_string( $row_span_repeater_key ); ?>>
									...
									<div class="bdt-static-body-row-cell-wrap">
										<div class="bdt-static-body-row-cell-text">
											<?php echo esc_html( $static_table_cell[ $j ]['title'] ); ?>
										</div>
	...
	public function google_sheet_table() {
		...
		if ( empty ( $sheet_data['values'] ) or isset ( $sheet_data['error'] ) ) {
			...
			$errors = esc_html__( 'Requested entity was not found or empty.', 'bdthemes-element-pack' );
		...
		<table class="bdt-google-sheet-table">
	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'table-wrapper' ); ?>>
			...
			if ( 'custom' == $settings['source'] ) {
				...
				echo wp_kses_post( $this->csv_to_table() );
