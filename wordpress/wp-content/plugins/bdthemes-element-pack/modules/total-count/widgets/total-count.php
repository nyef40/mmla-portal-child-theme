...
class Total_Count extends Module_Base {
	...
	protected function render_icon_heading() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'total-count-icon-heading' ); ?>>
			<?php $this->render_icon(); ?>
			<div class="bdt-counter-box-title-wrapper">
				<?php //if ( $settings['fake_count'] ):  ?>
				<div <?php $this->print_render_attribute_string( 'total-count-content-number' ); ?>>
	...
	protected function render_heading() {
		...
		<div <?php $this->print_render_attribute_string( 'total-count-content-number' ); ?>>
			<span class="bdt-count-this" id="bdt-total-count-data-<?php echo esc_attr( $id ); ?>" <?php $this->print_render_attribute_string( 'content_number' ); ?>>
				<?php $this->render_total_count(); ?>
			</span>
		</div>
		<?php
	...
	protected function render() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'total-count' ); ?> 		<?php $this->print_render_attribute_string( 'advanced_counter_data' ); ?>>
