...
class Skin_Dropdown extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/bdt-user-login/section_content_custom_nav/before_section_start', [ $this, 'register_dropdown_button_controls' ] );
	}
			...
			<div class="bdt-user-login bdt-user-login-skin-dropdown">
				<?php if ( $settings['show_logged_in_content'] ) : ?>
					<a <?php $this->parent->print_render_attribute_string( 'dropdown-button' ); ?>>
						...
						<?php if ( 'yes' == $settings['show_avatar_icon_in_button'] ) { ?>
							<span
								class="bdt-user-login-button-avatar<?php echo ( 'yes' == $settings['show_avatar_icon_in_button'] ) ? '' : ' bdt-hidden@l'; ?>">
								<?php Icons_Manager::render_icon( $settings['avatar_icon'], [ 'aria-hidden' => 'true', 'class' => 'fa-fw' ] ); ?>
							</span>
						<?php } else { ?>
							<span
								class="bdt-user-login-button-avatar<?php echo ( 'yes' == $settings['show_avatar_in_button'] ) ? '' : ' bdt-hidden@l'; ?>">
				...
				<?php else : ?>
					...
					<a class="bdt-logout-button bdt-button bdt-button-primary"
						href="<?php echo esc_url( wp_logout_url( $logout_url ) ); ?>" class="bdt-ul-logout-menu">
