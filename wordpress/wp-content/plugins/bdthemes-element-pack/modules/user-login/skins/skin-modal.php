	...
	public function render() {
			...
			<div id="<?php echo esc_attr( $id ); ?>" class="bdt-user-login bdt-user-login-skin-dropdown">
				<?php if ( $settings['show_logged_in_content'] ) : ?>
					<a <?php $this->parent->print_render_attribute_string( 'modal-button' ); ?>>
						...
						<span
							class="bdt-user-login-button-avatar<?php echo ( '' == $settings['show_avatar_in_button'] ) ? ' bdt-hidden@l' : ''; ?>">
				...
				<?php else : ?>
					...
					?>
					<a class="bdt-logout-button bdt-button bdt-button-primary" href="<?php echo esc_url( wp_logout_url( $logout_url ) ); ?>"
						class="bdt-ul-logout-menu">
		...
		<div class="bdt-user-login bdt-user-login-skin-modal">
			...
			<div id="<?php echo esc_attr( $id ); ?>"
				class="bdt-flex-top bdt-user-login-modal bdt-modal-<?php echo esc_attr( $modal_width ); ?>" data-bdt-modal>
					...
					<?php if ( $this->get_instance_value( 'modal_header' ) ) : ?>
						<div class="bdt-modal-header">
							<h2 class="bdt-modal-title"><span class="ep-icon-user-circle-o"></span>
								<?php esc_html_e( 'User Login!', 'bdthemes-element-pack' ); ?>
							</h2>
						</div>
					<?php endif; ?>
