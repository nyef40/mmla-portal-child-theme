...
?>
		<div class="bdt-wc-carousel-image bdt-background-cover">
			<a href="<?php the_permalink(); ?>" title="<?php echo esc_html(get_the_title()); ?>">
			...
			if ($settings['show_cart']) {
				...
				echo '<div class="bdt-wc-add-to-cart ' . wp_kses_post($show_cart_always) . '">';
	...
	public function render_quick_view($product_id) {
		...
		if ($settings['show_quick_view']) : ?>
			<div class="bdt-quick-view">
				...
				<input type="hidden" class="bdt_modal_spinner_message" value="<?php echo esc_html__('Please wait...', 'bdthemes-element-pack'); ?>" />
				<a href="javascript:void(0)" data-id="<?php echo absint($product_id); ?>" data-bdt-tooltip="title: <?php echo esc_html__('Quick View', 'bdthemes-element-pack'); ?>; pos: left;">
	...
	public function render_header($skin = 'default') {
		...
		<div <?php $this->print_render_attribute_string('carousel'); ?>>
			<div <?php $this->print_render_attribute_string('swiper'); ?>>
				<div <?php $this->print_render_attribute_string('wc-carousel-wrapper'); ?>>
					<?php
				}
				...
				public function render_loop_item() {
					...
					?>
							<div <?php $this->print_render_attribute_string('wc-carousel-item'); ?>>
									...
									<div class="bdt-wc-carousel-desc bdt-padding bdt-position-relative bdt-text-<?php echo esc_attr($text_align); ?>">
										<div class="bdt-wc-carousel-desc-inner">
											<?php if ($settings['show_title']) : ?>
												<<?php echo esc_html(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('bdt-wc-carousel-title'); ?>>
													<?php the_title(); ?>
												</<?php echo esc_html(Utils::get_valid_html_tag($settings['title_tags'])); ?>>
											<?php endif; ?>
