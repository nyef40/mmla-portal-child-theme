...
?>
            ...
            <div class="bdt-dotnav-wrapper bdt-dots-container">
                <ul class="bdt-dotnav bdt-flex-center">
                    ...
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                        ...
                        echo '<li class="bdt-slideshow-dotnav' . esc_attr($active) . '" data-bdt-slideshow-item=" ' . esc_attr($bdt_counter) . ' "><a href="#"></a></li>';
                        $bdt_counter++;
                    endwhile;
                    wp_reset_postdata(); ?>
                    ...
                    <?php if ('center' !== $settings['both_position']) : ?>
                        <div class="bdt-dotnav-wrapper bdt-dots-container">
                            <ul class="bdt-dotnav">
                                ...
                                while ($wp_query->have_posts()) : $wp_query->the_post();
                                    echo '<li class="bdt-slideshow-dotnav" data-bdt-slideshow-item="' . esc_html($bdt_counter) . '"><a href="#"></a></li>';
                                    $bdt_counter++;
                                endwhile;
                                wp_reset_postdata(); ?>
                            </ul>
    ...
    public function render_item_image() {
        ...
        if ($image_src) :
            echo '<img src="' . esc_url($image_src) . '" alt="' . esc_html(get_the_title()) . '">';
        endif;
    ...
    ?>
        <div <?php $this->print_render_attribute_string('slider_settings'); ?>>
    ...
    ?>
        <div class="bdt-slideshow-content-wrapper bdt-padding bdt-text-<?php echo esc_attr($settings['text_align']); ?>">
            ...
            <?php if ($settings['show_title']) : ?>
                <<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('bdt-wc-slider-title'); ?>><?php the_title(); ?></<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?>>
            <?php endif; ?>
                        ...
                        <div class="bdt-position-relative bdt-wc-slider-image">
                            ...
                            <?php elseif ($settings['show_badge'] and $product->is_on_sale()) : ?>
                                <div class="bdt-badge bdt-position-top-left bdt-position-small">
                                    <?php //woocommerce_show_product_loop_sale_flash();
                                    ?>
                                    <?php echo wp_kses_post(apply_filters('woocommerce_sale_flash', '<span class="bdt-onsale">' . esc_html__('Sale!', 'woocommerce') . '</span>', $post, $product)); ?>
                                </div>
                            <?php endif; ?>
