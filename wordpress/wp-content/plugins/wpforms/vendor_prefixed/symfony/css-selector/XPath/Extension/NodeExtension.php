 ...
 */
namespace WPForms\Vendor\Symfony\Component\CssSelector\XPath\Extension;

use WPForms\Vendor\Symfony\Component\CssSelector\Node;
use WPForms\Vendor\Symfony\Component\CssSelector\XPath\Translator;
use WPForms\Vendor\Symfony\Component\CssSelector\XPath\XPathExpr;
/**
...
class NodeExtension extends AbstractExtension
{
    ...
    {
        return array('Selector' => array($this, 'translateSelector'), 'CombinedSelector' => array($this, 'translateCombinedSelector'), 'Negation' => array($this, 'translateNegation'), 'Function' => array($this, 'translateFunction'), 'Pseudo' => array($this, 'translatePseudo'), 'Attribute' => array($this, 'translateAttribute'), 'Class' => array($this, 'translateClass'), 'Hash' => array($this, 'translateHash'), 'Element' => array($this, 'translateElement'));
    }
    /**
